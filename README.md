...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/moujaappck)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/moujaappck
```

A live public deployment of this template is available at [https://moujaappck.templates.workers.dev](https://moujaappck.templates.workers.dev)
